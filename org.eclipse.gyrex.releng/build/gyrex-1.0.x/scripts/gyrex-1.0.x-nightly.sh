...
projRelengPath='-projRelengPath org.eclipse.gyrex/releng/org.eclipse.gyrex.releng/build/gyrex-1.0.x'
...
if [[ ! -d $cvsProjectBaseDir ]]; then cvsProjectBaseDir=~/buildworkspace; fi # local build? 
